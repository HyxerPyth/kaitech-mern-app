...
const TalkingCircleComponentContainer = (props) => {
    ...
    const getResponse = async () => {
        ...
        try {
            const res = await axios.post('https://970e-162-245-68-145.ngrok-free.app/get-response', request_data, {
                headers: {
            ...
            try {
                const response = await axios.post('https://970e-162-245-68-145.ngrok-free.app/get-response-audio', request_data_audio, {
                    responseType: 'blob',
                    headers: {
                        'Content-Type': 'application/json; charset=UTF-8',
                        'ngrok-skip-browser-warning': 'skip-browser-warning',
    ...
    const handleTEST = () => {
        axios.get('https://970e-162-245-68-145.ngrok-free.app/test', { 
            headers: {
            'Content-Type': 'application/json; charset=UTF-8',
            'ngrok-skip-browser-warning': 'skip-browser-warning',
        }}
